...
object KeyLetter {
    ...
    fun getKorLetters(): List<List<KeyModel>> = listOf(
        ...
        listOf(
            ...
            KeyModel(keyType = KeyType.LETTER, mainText = "ㅡ", rtText = "˙", mainColor = textColor, rtColor = textColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 16)
        )
    )
    ...
    fun getEngLetter(): List<List<KeyModel>> = listOf(
        listOf(
            KeyModel(keyType = KeyType.LETTER, ltText = "w", rtText = "˙", rbText = "q", ltTextSize = smallEngSize, rbTextSize = smallEngSize, ltColor = textColor, rtColor = textColor, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 0, ltTextMarginLeft = 10, ltTextMarginTop = -10, rbTextMarginRight = 25, rbTextMarginBottom = 15),
    ...
    KeyModel(keyType = KeyType.LETTER, ltText = "o", rtText = "˙",ltTextSize = smallEngSize, rbTextSize = smallEngSize, ltColor = textColor, rtColor = textColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 7, ltTextMarginLeft = 10, ltTextMarginTop = -10)
    ),
    listOf(
    KeyModel(keyType = KeyType.LETTER, ltText = "a", rtText = "˙", ltTextSize = smallEngSize,ltColor = textColor, rtColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 9, ltTextMarginLeft = 10, ltTextMarginTop = -10),
    ...
    KeyModel(keyType = KeyType.LETTER, ltText = "m", rbText = "k", ltTextSize = smallEngSize, rbTextSize = smallEngSize,ltColor = textColor, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 15, ltTextMarginLeft = 10, ltTextMarginTop = -10, rbTextMarginRight = 25, rbTextMarginBottom = 15),
        KeyModel(keyType = KeyType.LETTER, ltText = "l", rtText = "˙", ltTextSize = smallEngSize, ltColor = textColor, rtColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 16, ltTextMarginLeft = 10, ltTextMarginTop = -10)
    )
    )
    ...
    fun getEngShiftLetter(): List<List<KeyModel>> = listOf(
        listOf(
            KeyModel(KeyType.LETTER, ltText = "W", rtText = "˙", rbText = "Q", rtColor = textColor, ltColor = textColor, ltTextSize = largeEngSize, rbTextSize = largeEngSize, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 0, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25, rbTextGravity = 85, rbTextMarginRight = 15, rbTextMarginBottom = 25),
            KeyModel(KeyType.LETTER, ltText = "E", ltColor = textColor, ltTextSize = largeEngSize, rbTextSize = largeEngSize,backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 1, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25),
            KeyModel(KeyType.LETTER, ltText = "R", rbText = "F", ltColor = textColor, ltTextSize = largeEngSize, rbTextSize = largeEngSize,rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 2, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25, rbTextGravity = 85, rbTextMarginRight = 15, rbTextMarginBottom = 25),
            KeyModel(KeyType.LETTER, ltText = "T", rbText = "G", ltColor = textColor, ltTextSize = largeEngSize,rbTextSize = largeEngSize, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 3, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25, rbTextGravity = 85, rbTextMarginRight = 15, rbTextMarginBottom = 25),
            KeyModel(KeyType.LETTER, ltText = "Y", rbText = "P", ltColor = textColor, ltTextSize =  largeEngSize, rbTextSize = largeEngSize,rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 4, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25, rbTextGravity = 85, rbTextMarginRight = 15, rbTextMarginBottom = 25),
            KeyModel(KeyType.LETTER, ltText = "U", ltColor = textColor, ltTextSize = largeEngSize, rbTextSize = largeEngSize,backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 5, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25),
            KeyModel(KeyType.LETTER, ltText = "I", ltColor = textColor, ltTextSize = largeEngSize, rbTextSize = largeEngSize,backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 6, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25),
            KeyModel(KeyType.LETTER, ltText = "O", rtText = "˙", ltColor = textColor, rtColor = textColor, ltTextSize = largeEngSize, rbTextSize = largeEngSize,backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 7, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25)
        ),
        listOf(
            KeyModel(KeyType.LETTER, ltText = "A", rtText = "˙", ltTextSize = largeEngSize, ltColor = textColor, rtColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 9, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25),
            KeyModel(KeyType.LETTER, ltText = "S", rbText = "Z", ltTextSize = largeEngSize,rbTextSize = largeEngSize,ltColor = textColor, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 10, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25, rbTextGravity = 85, rbTextMarginRight = 15, rbTextMarginBottom = 25),
            KeyModel(KeyType.LETTER, ltText = "D", rbText = "X", ltTextSize = largeEngSize,rbTextSize = largeEngSize,ltColor = textColor, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 11, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25, rbTextGravity = 85, rbTextMarginRight = 15, rbTextMarginBottom = 25),
            KeyModel(KeyType.LETTER, ltText = "C", rbText = "V", ltTextSize = largeEngSize,rbTextSize = largeEngSize,ltColor = textColor, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 12, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25, rbTextGravity = 85, rbTextMarginRight = 15, rbTextMarginBottom = 25),
            KeyModel(KeyType.LETTER, ltText = "H", rbText = "B", ltTextSize = largeEngSize,rbTextSize = largeEngSize,ltColor = textColor, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 13, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25, rbTextGravity = 85, rbTextMarginRight = 15, rbTextMarginBottom = 25),
            KeyModel(KeyType.LETTER, ltText = "N", rbText = "J", ltTextSize = largeEngSize,rbTextSize = largeEngSize,ltColor = textColor, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 14, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25, rbTextGravity = 85, rbTextMarginRight = 15, rbTextMarginBottom = 25),
            ...
            KeyModel(KeyType.LETTER, ltText = "L", rtText = "˙", ltTextSize = largeEngSize,ltColor = textColor, rtColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 16, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25)
            )
        )
    ...
    fun getNumberFuntion( language: CurrentLanguage): List<KeyModel> = listOf(
        KeyModel(
            ...
            height = keyHeight, width = functionWidth, layout_weight = 9f),
        KeyModel(keyType =  if (language == CurrentLanguage.KOR) KeyType.KOR else KeyType.ENG, mainText = if (language == CurrentLanguage.KOR) "ㄱㄴㄷ" else "ABC", mainColor = textColor, mainTextSize = 15f, backgroundColor = functionBg, selectBackgroundColor = functionBg, height = keyHeight, width = functionWidth, layout_weight = 9f),
    ...
    fun getSpectialFuntion( language: CurrentLanguage): List<KeyModel> = listOf(
        ...
        KeyModel(
            ...
            mainTextSize = 15f, backgroundColor = functionBg, selectBackgroundColor = functionBg, height = keyHeight, width = functionWidth, layout_weight = 9f),
        KeyModel(keyType = KeyType.SPACE, mainText = if (language == CurrentLanguage.KOR) "스페이스" else "Space",mainTextSize = 18f, mainColor = textColor, backgroundColor = backgroundColor),
        KeyModel(keyType = KeyType.RETURN, image = R.drawable.ic_enter, mainTextSize = 15f, selectImage = R.drawable.ic_enter, backgroundColor = functionBg, selectBackgroundColor = functionBg, height = keyHeight, width = functionWidth + keyWidth + 6, layout_weight = 8f),
        KeyModel(keyType = KeyType.DELETE, mainText = "⌫", mainTextSize = 20f, mainColor = textColor, backgroundColor = functionBg, selectBackgroundColor = functionBg, height = keyHeight, width = functionWidth, layout_weight = 9f),
        KeyModel(keyType = KeyType.NONE, mainText = "", mainColor = textColor, backgroundColor = functionBg, selectBackgroundColor = functionBg, height = keyHeight, width = functionWidth + keyWidth + 6)
