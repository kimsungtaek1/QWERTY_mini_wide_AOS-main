...
object KeyLetter {
    ...
    KeyModel(keyType = KeyType.LETTER, ltText = "u", rbText = "'", ltTextSize = smallEngSize, rbTextSize = smallEngSize,ltColor = textColor, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 5, ltTextGravity = 3, ltTextMarginLeft = 30, ltTextMarginTop = -5, rbTextGravity = 85, rbTextMarginRight = 15, rbTextMarginBottom = -10),
    KeyModel(keyType = KeyType.LETTER, ltText = "i", ltTextSize = smallEngSize, rbTextSize = smallEngSize,ltColor = textColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 6, ltTextGravity = 3, ltTextMarginLeft = 30, ltTextMarginTop = -10),
    KeyModel(keyType = KeyType.LETTER, ltText = "o", rtText = "˙",ltTextSize = smallEngSize, rtTextSize = 60f, rbTextSize = smallEngSize, ltColor = textColor, rtColor = textColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 7, ltTextGravity = 3, ltTextMarginLeft = 35, ltTextMarginTop = -5, rtTextGravity = 5, rtTextMarginRight = 10, rtTextMarginTop = -25)
    ),
    listOf(
