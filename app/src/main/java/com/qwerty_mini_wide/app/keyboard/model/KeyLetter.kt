...
object KeyLetter {
    ...
    fun getKorLetters(): List<List<KeyModel>> = listOf(
        ...
        listOf(
            ...
            KeyModel(keyType = KeyType.LETTER, mainText = "ㅡ", rtText = "˙", mainColor = textColor, rtColor = textColor, rtTextSize = 30f, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 16)
        )
    )
    ...
    fun getEngLetter(): List<List<KeyModel>> = listOf(
        listOf(
            KeyModel(keyType = KeyType.LETTER, ltText = "w", rtText = "˙", rbText = "q", ltTextSize = smallEngSize, rtTextSize = 30f, rbTextSize = smallEngSize, ltColor = textColor, rtColor = textColor, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 0, ltTextMarginLeft = 10, ltTextMarginTop = -10, rbTextMarginRight = 25, rbTextMarginBottom = 15),
    ...
    KeyModel(keyType = KeyType.LETTER, ltText = "o", rtText = "˙",ltTextSize = smallEngSize, rtTextSize = 30f, rbTextSize = smallEngSize, ltColor = textColor, rtColor = textColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 7, ltTextMarginLeft = 10, ltTextMarginTop = -10)
    ),
    listOf(
    KeyModel(keyType = KeyType.LETTER, ltText = "a", rtText = "˙", ltTextSize = smallEngSize, rtTextSize = 30f, ltColor = textColor, rtColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 9, ltTextMarginLeft = 10, ltTextMarginTop = -10),
    ...
    KeyModel(keyType = KeyType.LETTER, ltText = "m", rbText = "k", ltTextSize = smallEngSize, rbTextSize = smallEngSize,ltColor = textColor, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 15, ltTextMarginLeft = 10, ltTextMarginTop = -10, rbTextMarginRight = 25, rbTextMarginBottom = 15),
        KeyModel(keyType = KeyType.LETTER, ltText = "l", rtText = "˙", ltTextSize = smallEngSize, rtTextSize = 30f, ltColor = textColor, rtColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 16, ltTextMarginLeft = 10, ltTextMarginTop = -10)
    )
    )
    ...
    fun getEngShiftLetter(): List<List<KeyModel>> = listOf(
        listOf(
            KeyModel(KeyType.LETTER, ltText = "W", rtText = "˙", rbText = "Q", rtColor = textColor, ltColor = textColor, ltTextSize = largeEngSize, rtTextSize = 30f, rbTextSize = largeEngSize, rbColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 0, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25, rbTextGravity = 85, rbTextMarginRight = 15, rbTextMarginBottom = 25),
            ...
            KeyModel(KeyType.LETTER, ltText = "O", rtText = "˙", ltColor = textColor, rtColor = textColor, ltTextSize = largeEngSize, rtTextSize = 30f, rbTextSize = largeEngSize,backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 7, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25)
        ),
        listOf(
            KeyModel(KeyType.LETTER, ltText = "A", rtText = "˙", ltTextSize = largeEngSize, rtTextSize = 30f, ltColor = textColor, rtColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 9, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25),
            ...
            KeyModel(KeyType.LETTER, ltText = "L", rtText = "˙", ltTextSize = largeEngSize, rtTextSize = 30f, ltColor = textColor, rtColor = subletterColor, backgroundColor = backgroundColor, height = keyHeight, width = keyWidth, tag = 16, ltTextGravity = 3, ltTextMarginLeft = 10, ltTextMarginTop = 25)
            )
        )
